import { dynamicPropDefinition, propsDefinition } from './atlasManager.js';
...
function createProp(type, data) {
    ...
    if(propsDefinition.srcs[`/stream-view${data.texture}`]) data.texture = `/stream-view${data.texture}`;
